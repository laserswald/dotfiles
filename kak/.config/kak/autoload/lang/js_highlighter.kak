...
define-command -override -hidden javascript-filter-around-selections %{
    # remove trailing white spaces
    try %{ execute-keys -draft -itersel <a-x> s \h+$ <ret> d }
}

define-command -override -hidden javascript-indent-on-char %<
...
define-command -override -hidden javascript-indent-on-new-line %<
    evaluate-commands -draft -itersel %<
...
remove-highlighter shared/javascript
remove-highlighter shared/typescript

# Highlighting and hooks bulder for JavaScript and TypeScript
# ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾
define-command -override -hidden init-javascript-filetype -params 1 %~
    # Highlighters
    # ‾‾‾‾‾‾‾‾‾‾‾‾
    ...
    add-highlighter "shared/%arg{1}/code" regex \b(Array|Boolean|Date|Function|Number|Object|RegExp|String|Symbol|var|let)\b 0:type
    add-highlighter "shared/%arg{1}/code" regex \b([A-Z][a-z])\b 0:type
    ...
    add-highlighter "shared/%arg{1}/code" regex \b(async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|export|extends|finally|for|function|if|import|in|instanceof|new|of|return|static|super|switch|throw|try|typeof|void|while|with|yield)\b 0:keyword

    add-highlighter "shared/%arg{1}/code" regex (\w+)\( 1:function
