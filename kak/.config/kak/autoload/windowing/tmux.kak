...
define-command -override -hidden -params 2.. tmux-terminal-impl %{
    evaluate-commands %sh{
        ...
        tmux $tmux_args "$@" < /dev/null >>~/tmuxlog 2>&1 &
    }
}

define-command -override tmux-terminal-vertical -params 1.. -shell-completion -docstring '
...
define-command -override tmux-terminal-horizontal -params 1.. -shell-completion -docstring '
...
define-command -override tmux-terminal-window -params 1.. -shell-completion -docstring '
...
define-command -override tmux-focus -params ..1 -client-completion -docstring '
