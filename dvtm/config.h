...
static Color colors[] = {
	...
	[FOCUSED] = { .fg = -1, .bg = COLOR_WHITE, .fg256 = -1, .bg256 = COLOR_WHITE, },
	[URGENT]  = { .fg = COLOR_BLUE, .bg = -1, .fg256 = -1, .bg256 = COLOR_RED, },
	[NORMAL]  = { .fg = COLOR_BLUE, .bg = COLOR_BLACK, .fg256 = -1, .bg256 = COLOR_BLACK, },
};

#define COLOR(c)        COLOR_PAIR(colors[c].pair)

/* curses attributes for the currently focused window */
#define SELECTED_ATTR   (COLOR(FOCUSED) | A_NORMAL)
/* curses attributes for normal (not selected) windows */
#define NORMAL_ATTR     (COLOR(NORMAL) | A_NORMAL)
/* curses attributes for a window with pending urgent flag */
#define URGENT_ATTR     (COLOR(URGENT) | A_BLINK)
/* curses attributes for the status bar */
#define BAR_ATTR        (COLOR(NORMAL) | A_NORMAL)
...
#define TAG_SEL      (COLOR(FOCUSED) | A_BOLD)
/* curses attributes for not selected tags which contain no windows */
#define TAG_NORMAL   (COLOR(NORMAL) | A_NORMAL)
/* curses attributes for not selected tags which contain windows */
#define TAG_OCCUPIED (COLOR(FOCUSED) | A_NORMAL)
/* curses attributes for not selected tags which with urgent windows */
#define TAG_URGENT (COLOR(URGENT) | A_NORMAL | A_BLINK)
